...
import { View, Text, TextInput, Pressable, StyleSheet, SafeAreaView, ImageBackground } from 'react-native';
            ...
            <SafeAreaView style={styles.container}>
                <View style={styles.innerContainer}>
                    <View style={styles.headingStylesContainer}>
                        ...
                        <ThemedText style={styles.subtitle}>Welcome back we're glad to have you!</ThemedText>
                    </View>
                    ...
                    <View style={styles.checkboxContainer}>
                        ...
                        <ThemedText style={styles.checkboxLabel}>
                            I agree to the <ThemedText style={styles.termsText}>Terms and Conditions</ThemedText>
                        </ThemedText>
                    </View>
